          ...
          <div className="flex flex-col lg:flex-row justify-between items-start gap-12 py-8">
            ...
            <div className="flex-shrink-0">
              <Image
                ...
                height={210}
                unoptimized
                className="object-contain w-[120px] h-[120px] sm:w-[210px] sm:h-[210px] transition-transform duration-300 ease-out hover:scale-105"
              />
            </div>
                ...
                <ul className="space-y-2.5">
                  {companyLinks.map((link) => (
                    <li key={link.label}>
                      <Link
                        href={link.href}
                        className="text-heading-h4 md:text-heading-h3 font-normal text-white transition-[color,transform] duration-200 ease-out hover:text-water-200 hover:translate-x-1 inline-block"
                      >
                        {link.label}
                      </Link>
                    </li>
              ...
              <div>
                ...
                <ul className="space-y-2.5">
                  {serviceLinks.map((item, index) => (
                    <li key={index}>
                      <Link href={item.href} className="text-heading-h4 md:text-heading-h3 font-normal text-white transition-[color,transform] duration-200 ease-out hover:text-water-200 hover:translate-x-1 inline-block">
                        {item.label}
                      </Link>
                    </li>
                  ))}
