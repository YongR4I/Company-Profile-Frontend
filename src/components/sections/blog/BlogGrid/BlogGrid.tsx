        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          {posts.map((post) => (
            <Link
              key={post.id}
              href={`/blog/${post.slug}`}
              className="group flex flex-col bg-water-900 border border-water-300/10 rounded-2xl overflow-hidden hover:border-water-300/30 transition-all duration-300"
            >
              ...
              <div className="flex flex-col gap-3 p-5 md:p-6 flex-1">
                <h3 className="text-white text-heading-h5 font-medium line-clamp-2 group-hover:text-water-300 transition-colors">
                  {post.title}
                </h3>
                ...
                <div className="mt-auto flex items-center gap-3 pt-4 border-t border-white/5">
                  <div className="w-9 h-9 rounded-full bg-water-700 flex-shrink-0 overflow-hidden">
