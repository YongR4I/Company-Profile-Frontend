...
export default function SolutionCard({ solution }: SolutionCardProps) {
  return (
    <div
      className={`group w-full max-w-[512px] h-[594px] bg-water-900 border border-water-300/20 hover:border-water-300/40 rounded-[20px] pb-[30px] px-[25px] flex flex-col relative overflow-hidden mx-auto ${solution.paddingTop} ${solution.marginTop}`}
    >
      {/* The Text Content */}
